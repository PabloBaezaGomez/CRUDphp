...
ALTER TABLE stock ADD CONSTRAINT stock_ibfk_2 FOREIGN KEY(store) REFERENCES store (cod) ON DELETE CASCADE ON UPDATE CASCADE, ADD CONSTRAINT stock_ibfk_1 FOREIGN KEY(product) REFERENCES product (cod) ON DELETE CASCADE ON UPDATE CASCADE;
